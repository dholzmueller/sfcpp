...
#ifndef SRC_LATEX_TIKZ_TIKZLINE_HPP_
#define SRC_LATEX_TIKZ_TIKZLINE_HPP_
...
class TikzLine: public TikzElement {
...
public:
	TikzLine(Eigen::Vector3d startPoint, Eigen::Vector3d endPoint, TikzElementConfiguration config = TikzElementConfiguration());
	TikzLine(TikzLine const &other);
	virtual ~TikzLine();
...
#endif /* SRC_LATEX_TIKZ_TIKZLINE_HPP_ */
